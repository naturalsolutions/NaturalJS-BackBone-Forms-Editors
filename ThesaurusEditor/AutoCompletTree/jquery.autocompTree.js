            ...
            init: function (parametres) {
                ...
                _self.each(function () {
                    ...
                    $('#treeView' + $me.attr("id")).fancytree({
                        ...
                        source:
                        (parametres.storedTree ? (topNode.children != null ? topNode.children : [topNode]) :
                            {
                                type: "POST",
                        ...
                        init: function (event, data) {
                            if (thesDatas.length == 1) {
                                var onlyData = thesDatas[0];
                                if (onlyData.key != "0") {
                                    $me.val(onlyData.fullpathTranslated);
                                    $("#" + $me.attr('id') + parametres.display.suffixeId).val(onlyData.fullpath);
                                }
                                else {
                                    console.log("Dev work needed, this has not been translated when changing the default value affectation system");
                                    /*
